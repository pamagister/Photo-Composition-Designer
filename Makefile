...
fmt:              ## Format code using black & isort.
	...
	$(ENV_PREFIX)black -l 120 -t py311 designer/
	$(ENV_PREFIX)black -l 120 -t py311 tests/

.PHONY: lint
lint:             ## Run pep8, black, mypy linters.
	$(ENV_PREFIX)flake8 designer/
	$(ENV_PREFIX)black -l 120 -t py311 --check designer/
	$(ENV_PREFIX)black -l 120 -t py311 --check tests/
