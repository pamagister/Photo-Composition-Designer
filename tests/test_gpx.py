...
from src.Photo_Composition_Designer.core.base import BaseGPXProcessor
...
class TestGPXProcessor(unittest.TestCase):
    ...
    def setUp(self):
        ...
        """
        # Get the directory of the current test file (e.g., C:/dev/Photo-Composition-Designer/tests)
