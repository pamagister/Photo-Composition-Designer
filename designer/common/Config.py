...
DEFAULT_CONFIG = [
    ...
    ("SIZE", "mapWidth", 25, int, "Width of the locations map in mm"),
    ("SIZE", "mapHeight", 25, int, "Height of the locations map in mm"),
    ...
    ("LAYOUT", "fontSizeAnniversaries", 0.12, float, "Font size for anniversaries"),
    ("LAYOUT", "marginBottom", 4, int, "Bottom margin in mm"),
    ("LAYOUT", "marginSides", 4, int, "Side margins in mm"),
