...
DEFAULT_CONFIG = [
    ...
    ("CALENDAR", "collagesToGenerate", 55, int, "Number of collages to be generated (e.g. number of weeks)"),
    # COLORS
    ...
    # SIZE
    ("SIZE", "width", 216, int, "Width of the collage in mm"),
    ("SIZE", "height", 154, int, "Height of the collage in mm"),
    ("SIZE", "calendarHeight", 18, int, "Height of the calendar area in mm"),
    ...
    ("SIZE", "jpgQuality", 90, int, "JPG compression quality (1-100)"),
    # LAYOUT
